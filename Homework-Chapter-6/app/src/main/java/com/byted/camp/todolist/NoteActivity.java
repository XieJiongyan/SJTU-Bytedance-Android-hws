...
public class NoteActivity extends AppCompatActivity {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!is_edit) {
                    ...
                    succeed = updateNode(content.toString().trim(),
                            getSelectedPriority());
                    database.close();
                    database = null;
                    dbHelper.close();
                ...
                if (succeed) {
                    Toast.makeText(NoteActivity.this,
                            "Note added/changed", Toast.LENGTH_SHORT).show();
    ...
    private boolean updateNode(String content, Priority priority) {
        if (database == null) {
            return false;
        }
        ContentValues values = new ContentValues();
